...
a variable is a value that stores and represents another value be it a method, equation, etc
...
objects are created within a class - ie molly is an object of the human class

# 5. What is an instance variable?

an instance variable is an attribute of an object
...
class Computer
  ...
  mollyscomp = Computer.new(brand: 'Macbook', year: 2011)
...
they provide additional functionality that is not inbuilt to Ruby ie adding colors, timers, geocoding, etc
...
def arrayception(array)
  array.partition do |i| 
		divbythree(i)
end
end

p arrayception(a=[9, 4, 3, 5, 30, 2, 8])
